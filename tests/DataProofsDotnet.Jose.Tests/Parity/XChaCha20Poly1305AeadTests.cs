...
/// <summary>
/// Tests for <see cref="XChaCha20Poly1305Aead"/> — JOSE <c>XC20P</c> (delegating to NetCrypto's
/// <c>XChaCha20Poly1305Cipher</c>; see AeadShims.cs). The primitive is validated against
/// draft-irtf-cfrg-xchacha-03 upstream; we test the wrapper's IO contract and tag splitting.
/// AC-3 adds a generated+frozen XC20P vector set (jose-jwt lacks XC20P) — see
/// Conformance/GeneratedVectorTests.cs.
/// </summary>
