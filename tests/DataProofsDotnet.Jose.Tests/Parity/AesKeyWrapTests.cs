...
namespace DataProofsDotnet.Jose.Tests.Crypto.KeyWrap;

/// <summary>
/// Tests for <see cref="AesKeyWrap"/> — RFC 3394 / RFC 7518 §4.4 (<c>A256KW</c>). The local
/// RFC 3394 implementation of the porting source was deleted (AC-6); these black-box vectors
/// now pin NetCrypto's <c>AesKeyWrap</c> statics, which share the same name and call shape.
