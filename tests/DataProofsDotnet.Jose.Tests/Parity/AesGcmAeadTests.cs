...
/// <summary>
/// Tests for <see cref="AesGcmAead"/> — JOSE <c>A256GCM</c> (delegating to NetCrypto's
/// <c>AesGcmCipher</c>; see AeadShims.cs). AES-GCM itself is RFC 5288 with canonical NIST CAVP
/// vectors validated upstream; we test the wrapper's IO contract (length validation,
