...
/// fixed-width <c>r ‖ s</c> form. W3C Data Integrity ECDSA suites put P1363 on the wire,
/// while NetCrypto's <c>ISigner</c>/<c>IKeyStore</c> surface returns DER for NIST curves;
/// this transcoder bridges the two without touching any cryptographic primitive (AC-6).
/// </summary>
/// <remarks>
/// A copy of Core's identically-named internal helper: Core does not expose its internals
/// to <c>Rdfc</c>, and the RDFC ECDSA suite needs the same transcode for P-256/P-384.
/// </remarks>
internal static class EcdsaSignatureEncoding
{
    ...
    /// <param name="fieldWidth">The curve field width in bytes (32 for P-256, 48 for P-384).</param>
